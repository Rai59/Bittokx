...
| `07-horizon.md` | AGI-era direction. **Not a build list.** |
...
Read order: PRD → approval policy → prototype cut in architecture → acceptance criteria. Decisions, research, and horizon are appendices. Re-read `06-review.md` before writing code. Do not implement `07-horizon.md` in week 1.
