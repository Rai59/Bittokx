...
how Cursor, Ramp, and Mercury present a company name.
...
| File | Use |
| --- | --- |
| `assets/logo/bittokx-mark.svg` | Mark, ink |
| `assets/logo/bittokx-mark-white.svg` | Mark, white |
| `assets/logo/bittokx-logo.svg` | Full lockup, ink |
